...
const RetroEffect = forwardRef((props, ref) => {
  const { colorNum, pixelSize, time } = props;
  return <WrappedRetro ref={ref} colorNum={colorNum} pixelSize={pixelSize} time={time} />;
});
...
function DitheredWaves({
  ...
  return (
    <>
      ...
      <EffectComposer>
        <RetroEffect ref={retroRef} colorNum={colorNum} pixelSize={pixelSize} time={ditherTime} />
      </EffectComposer>
